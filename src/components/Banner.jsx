          ...
          <div className='container'>
            <div className='row'>
              <div className='bannerText'>
                <h2 className='text-sm md:text-2xl font-medium font-poppins text-primary md:mb-6 mb-2'>Starting from: $49.99</h2>
                <h1 className='text-3xl md:text-6xl font-semibold text-second font-poppins '>Exclusive collection for everyone</h1>
          ...
          <div className='container'>
            <div className='row'>
              <div className='bannerText'>
                ...
                <h1 className='text-3xl md:text-6xl font-semibold text-second font-poppins '>Fresh styles for your comfort</h1>
                <Link className='w-[198px] h-[64px] rounded-[9999px] bg-second flex justify-center items-center text-[#fff] text-[16px] font-medium font-poppins mt-[24px]' to={'#'}>Explore now <CiSearch className='text-[20px] text-[#F8FAFC] ml-[10px]' /> </Link>
              </div>
            </div>
          </div>

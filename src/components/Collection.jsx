...
export const Collection = () => {
  return (
    <>
    <section id='collection_img' style={{background:`url(${banner2})`,backgroundPosition:'center',backgroundRepeat:'no-repeat',backgroundSize:'cover'}} className='max-sm:hidden mt-[55px] py-[150px] mb-[52px]'>
        <div className='container'>
            <div className='row'>
                <div className='bannerText'>
                    <h3 className='text[20px] font-medium font-poppins text-primary mb-[14px]'>100% Original Products</h3>
                    <h2 className='md:text-[37px] text-[30px] font-poppins font-semibold text-second w-[370px] leading-[40px]'>The All New Fashion
                       Collection Items</h2>

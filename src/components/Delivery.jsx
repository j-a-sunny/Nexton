...
const Delivery = () => {
  return (
    ...
    // Spans are hidden till md:
    <section id='delivery' className='pt-[52px]'>
      <div className='container'>
        <div className='row border py-[24px] px-[40px] rounded-[16px] border-[#E5E7EB] flex flex-col md:flex-row justify-between'>
          ...
          <span className='flex hidden md:block h-[50px] w-[1px] border border-[#E5E7EB]'></span>
